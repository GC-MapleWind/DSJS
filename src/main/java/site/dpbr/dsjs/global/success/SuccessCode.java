...
public enum SuccessCode {
    UPLOAD_FILE_SUCCESS(201, "UPLOAD_FILE_SUCCESS", "엑셀 파일에 있는 캐릭터들의 정보를 저장하는데 성공했습니다."),
    UPLOAD_AND_FETCH_SUCCESS(201, "UPLOAD_AND_FETCH_SUCCESS", "엑셀 파일에 있는 캐릭터들의 정보를 가져오는데 성공했습니다."),
